    ...
    <div>
      ...
      <div className="container">
        <div className="row py-5 my-5">
          ...
          <p>
            Pragati aims to establish a platform that connects parking owners
        ...
        <div className="row mt-5 mb-5">
          ...
          <div className="col-md-6 d-flex align-items-center">
            <div>
              ...
              <p>
                Parking Seekers can utilize the Pragati web application to
        ...
        <div className="row mt-5">
          <div className="col-md-6 d-flex align-items-center">
            <div className="text-right">
              <h3>Parking Owner</h3>
              <p>
                The Pragati web application offers a professional service for
                ...
                Pragati, parking owners can maximize the utilization of their
